...
from . import salaries_pb2 as salaries__pb2
...
if _version_not_supported:
    raise RuntimeError(
        ...
        + ' but the generated code in salaries_pb2_grpc.py depends on'
...
class SalaryServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        """
        self.GetGroupedSalaries = channel.unary_unary(
...
def add_SalaryServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetGroupedSalaries': grpc.unary_unary_rpc_method_handler(
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'salaries.SalaryService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('salaries.SalaryService', rpc_method_handlers)
...
class SalaryService(object):
    ...
    @staticmethod
    def GetGroupedSalaries(request,
            target,
            options=(),
